    ...
    <div>
          ...
          <div class="container">
            <div class="row mt-2 justify-content-center text-center">
              <div class="col-lg-12">
                <a
                  class="mr-3"
                  href="https://tr.linkedin.com/in/sefa-%C3%BCn-856034172"
                  target="_blank"
                >
                  <img class="linkler" src="./img/linkedin.png" alt />
                </a>
                <a class="mr-3" href="https://github.com/fesa6654" target="_blank">
                  <img class="linkler" src="./img/github.png" alt />
                </a>
                <a class="mr-3" href="https://www.facebook.com/Sefaun.10" target="_blank">
                  <img class="linkler" src="./img/facebook.png" alt />
                </a>
                <a class="mr-3" href="https://www.instagram.com/sefaun_10/" target="_blank">
                  <img class="linkler" src="./img/inst.png" alt />
                </a>
                <a class="mr-3" href="https://discord.gg/XHUnJbR" target="_blank">
                  <img class="linkler" src="./img/dc.png" alt />
                </a>
              </div>
            </div>
            <br />
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-lg-12">
            <h2 style="color: deeppink;">GELİŞTİRDİĞİM PROJE ÖRNEKLERİ</h2>
          </div>
        </div>
      </div>
      <hr />
              ...
              >
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="./slayt/alvemsis.png" class="d-block w-100 slayt-resimleri" alt="..." />
                    <div class="carousel-caption d-none d-md-block">
                      <h5 style="color: white;">Web Tasarımı</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="./slayt/api.png" class="d-block w-100 slayt-resimleri" alt="..." />
                    <div class="carousel-caption d-none d-md-block">
                      <h5 style="color: white;">Api Servisi Kod Örnekleri</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="./slayt/urunler.png" class="d-block w-100 slayt-resimleri" alt="..." />
                    <div class="carousel-caption d-none d-md-block">
                      <h5 class="slayt-baslik">Cafe-Restorant İşletmeleri İçin Adisyon Sitesi Örneği</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="./slayt/tablo.png" class="d-block w-100 slayt-resimleri" alt="..." />
                    <div class="carousel-caption d-none d-md-block">
                      <h5 class="slayt-baslik">Veritabanı İle Çalışan Tablolar</h5>
                    </div>
                  </div>
                </div>
                <a
                ...
                >
                  ...
                  <span class="sr-only">ÖNCEKİ</span>
                </a>
                <a
                ...
                >
                  ...
                  <span class="sr-only">SONRAKİ</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-lg-12">
            <h2 style="color: deeppink;">HAKKIMDA</h2>
          </div>
        </div>
        <hr />
        <br />
            ...
            <div class="col-12">
              ...
              <h5 class="animations">
                ...
                <a
                  style="color: deepskyblue;"
                >HTML</a> ve
                <a style="color: deepskyblue;">CSS</a> yazılım
                dilleri ile web tasarımı üzerine kendimi geliştirdim. Ardından web tasarımının tek başına yeterli olmadığını farkettim. Bu yüzden
                <a
                  style="color: deepskyblue;"
                >Javascript</a>,
                <a style="color: deepskyblue;">Vue.JS</a>,
                <a style="color: deepskyblue;">Nuxt.JS</a>,
                <a style="color: deepskyblue;">API RESTFUL</a> ve
              ...
              <h5 class="animations">
                ...
                <a
                  style="color: deepskyblue;"
                >Flutter</a> ile hem
                <a style="color: deepskyblue;">Android</a>'de hemde
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-lg-12">
            <h2 style="color: deeppink;">KULLANDIĞIM YAZILIM DİLLERİ VE PROGRAMLARI</h2>
          </div>
        </div>
      </div>
      <hr />
      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col">
            <img class="logos" src="./logos/js.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/html.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/css.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/node.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/ns.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/vue.png" alt />
            <div class="animasyonlar">VUE.JS</div>
          </div>
        </div>
        <br />
        <div class="row align-items-center justify-content-center text-center">
          <div class="col">
            <img class="logos" src="./logos/flutter.png" alt />
            <div class="animasyonlar">FLUTTER</div>
          </div>
          <div class="col">
            <img class="logos" src="./logos/nuxt.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/ms.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/gh.png" alt />
            <div class="animasyonlar">GİTHUB</div>
          </div>
          <div class="col">
            <img class="logos" src="./logos/git.png" alt />
          </div>
          <div class="col">
            <img class="logos" src="./logos/bs.png" alt />
            <div class="animasyonlar">BOOTSTRAP</div>
          </div>
        </div>
      </div>
      <br />
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-4">
            <br />
            <div class="row d-none d-lg-block justify-content-center text-center">
              <div class="col-lg-12">
                <img class="animasyon" src="./img/gmail.png" alt />
              </div>
            </div>
            <br class="d-none d-lg-block" />
            <br class="d-none d-lg-block" />
            ...
            <div class="row d-none d-lg-block justify-content-center text-center">
              <div class="col-lg-12">
                <img class="animasyon-1" src="./img/email.png" alt />
              </div>
            </div>
          </div>
              ...
              <div class="card-body renk44">
                ...
                <div class="row mt-2">
                  <div class="col-sm-12">
                    <label>
                      ...
                      <small
                        style="color: deepskyblue;"
                      >(E-Postanıza Tekrar Dönüş Yapabilmek İçin Gereklidir.)</small>
                    </label>
                    <input
                      v-model="mailinfo.eposta"
                      type="text"
                      class="form-control"
                ...
                <div class="row mt-2">
                  <div class="col-sm-12">
                    ...
                    <textarea
                      v-model="mailinfo.icerik"
                      class="form-control"
                      rows="3"
                      placeholder="E-Mail İçeriği Yaz..."
                    ></textarea>
                  </div>
                </div>
                <center>
                  <div class="row mt-3">
                    <div class="col-sm-12">
                      <b-button @click="mail_gonder()" size="sm" class="mt-2" variant="primary">
                        <b-icon class="mr-1" icon="envelope"></b-icon>Gönder
                      </b-button>
                    </div>
                  </div>
                </center>
          ...
          <div class="col-lg-4">
            ...
            <div class="row d-none d-lg-block justify-content-center text-center">
              <div class="col-lg-12">
                <img class="animasyon" src="./img/outlook.png" alt />
              </div>
            </div>
            <br class="d-none d-lg-block" />
            <br class="d-none d-lg-block" />
            ...
            <div class="row d-none d-lg-block justify-content-center text-center">
              <div class="col-lg-12">
                <img class="animasyon-1" src="./img/pcmail.png" alt />
              </div>
            </div>
          </div>
        </div>
      ...
      <br class="d-none d-lg-block" />
      <br />
      <div class="alt-footer footer-font">
        <div class="container-fluid pt-3">
          <div class="row justify-content-center text-center">
            <div class="col">
              <h3 style="color: deepskyblue;">REFERANSLAR</h3>
            </div>
          </div>
        </div>
        <hr style="border-top: 1px solid deeppink;" />
        <div class="container-fluid">
          <div class="row pt-1 justify-content-around text-center">
            <div class="col-lg-6">
              <a href="http://www.alvemsis.com/" target="_blanke">
                <img
                  style="background-color: white; border-radius: 3px; padding: 3px;"
                  class="alvemsis mt-3"
                  src="./img/alvemsis.png"
                  alt
                />
              </a>
            </div>
            <div class="col-lg-6">
              <a href="http://www.corbuselektrik.com.tr/" target="_blanke">
                <img class="corbus mt-3 mb-2" src="./img/corbus.png" alt />
              </a>
            </div>
          </div>
          <br />
  ...
  methods: {
    ...
    mail_gonder() {
      if (
        ...
        this.$store.commit("loading", "block");
        mailgonder
          ...
          .then((response) => {
            ...
            this.bildirimler(
              ...
              "Sayın" +
                ...
                this.mailinfo.isim +
                " " +
                "E-Mailinizi Aldım. En Kısa Sürede Size Cevap Vereceğim !",
          ...
          .catch((err) => {
            ...
            this.bildirimler(
              "Mail Gönderilemedi !",
              "E-Mailiniz Gönderilirken Hata Oluştu !",
              "b-toaster-top-center",
              "danger"
            );
          });
